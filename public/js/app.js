...
function updateCart(drinks) {
  axios__WEBPACK_IMPORTED_MODULE_0___default().post('/update-cart', drinks).then(function (res) {
...
addToCart.forEach(function (btn) {
  btn.addEventListener('click', function (e) {
    var drinks = JSON.parse(btn.dataset.drink);
    updateCart(drinks);
  });
});
...
_admin__WEBPACK_IMPORTED_MODULE_2__["default"];
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkcoffee_cafe"] = self["webpackChunkcoffee_cafe"] || [];
